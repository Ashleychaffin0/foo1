...
// This file was generated on Thursday, June 26, 2008 at 5:02:55 PM
...
//---------------------------------------------------------------------------------------
		...
		public static object Create<T>(ZuneQueryList zql, uint i) where T : class  {
			...
			if (t == typeof(eQueryTypeVideosByCategoryId)) return new eQueryTypeVideosByCategoryId(zql, i);
			...
			if (t == typeof(eQueryTypeTracksByGenreId)) return new eQueryTypeTracksByGenreId(zql, i);
			if (t == typeof(eQueryTypeAlbumsByGenreId)) return new eQueryTypeAlbumsByGenreId(zql, i);
			if (t == typeof(eQueryTypeUserCards)) return new eQueryTypeUserCards(zql, i);
			if (t == typeof(eQueryTypeTracksForTOC)) return new eQueryTypeTracksForTOC(zql, i);
			if (t == typeof(eQueryTypePersonsByTypeId)) return new eQueryTypePersonsByTypeId(zql, i);
			if (t == typeof(eQueryTypeVideoSeriesTitles)) return new eQueryTypeVideoSeriesTitles(zql, i);
...
//---------------------------------------------------------------------------------------
		...
		public eQueryTypeAllTracks(ZuneQueryList ZQList, uint n) {
			...
			o = ZQList.GetFieldValue(n, typeof(ArrayList), (uint)SchemaMap.kiIndex_ContributingComposers); ContributingComposers = (ArrayList)(o ?? default(ArrayList));
			o = ZQList.GetFieldValue(n, typeof(ArrayList), (uint)SchemaMap.kiIndex_ContributingConductors); ContributingConductors = (ArrayList)(o ?? default(ArrayList));
			...
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_WMComposer); WMComposer = (string)(o ?? default(string));
			...
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_WMWMContentID); WMWMContentID = (string)(o ?? default(string));
			o = ZQList.GetFieldValue(n, typeof(DateTime), (uint)SchemaMap.kiIndex_WMYear); WMYear = (DateTime)(o ?? default(DateTime));
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_ZuneMediaID); ZuneMediaID = (string)(o ?? default(string));
...
//---------------------------------------------------------------------------------------
		...
		public eQueryTypeAllVideos(ZuneQueryList ZQList, uint n) {
			...
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_WMAlbumArtist); WMAlbumArtist = (string)(o ?? default(string));
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_WMAlbumTitle); WMAlbumTitle = (string)(o ?? default(string));
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_WMDirector); WMDirector = (string)(o ?? default(string));
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_WMGenre); WMGenre = (string)(o ?? default(string));
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypeAlbumsForContributingArtistId {
		public static EQueryType EnumVal = EQueryType.eQueryTypeAlbumsForContributingArtistId;
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypeVideosByCategoryId {
		public static EQueryType EnumVal = EQueryType.eQueryTypeVideosByCategoryId;


//---------------------------------------------------------------------------------------

		public eQueryTypeVideosByCategoryId(ZuneQueryList ZQList, uint n) {
			object	o;

		}		// eQueryTypeVideosByCategoryId ctor
	}		// eQueryTypeVideosByCategoryId class
...
//---------------------------------------------------------------------------------------
		...
		public eQueryTypeAllPlaylists(ZuneQueryList ZQList, uint n) {
			...
			o = ZQList.GetFieldValue(n, typeof(int), (uint)SchemaMap.kiIndex_MediaID); MediaID = (int)(o ?? default(int));
			o = ZQList.GetFieldValue(n, typeof(EMediaTypes), (uint)SchemaMap.kiIndex_MediaType); MediaType = (EMediaTypes)(o ?? default(EMediaTypes));
			o = ZQList.GetFieldValue(n, typeof(int), (uint)SchemaMap.kiIndex_PlaylistType); PlaylistType = (int)(o ?? default(int));
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_SourceURL); SourceURL = (string)(o ?? default(string));
			o = ZQList.GetFieldValue(n, typeof(string), (uint)SchemaMap.kiIndex_Title); Title = (string)(o ?? default(string));
			o = ZQList.GetFieldValue(n, typeof(int), (uint)SchemaMap.kiIndex_TotalDuration); TotalDuration = (int)(o ?? default(int));
			o = ZQList.GetFieldValue(n, typeof(int), (uint)SchemaMap.kiIndex_UniqueID); UniqueID = (int)(o ?? default(int));
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypeTracksByGenreId {
		public static EQueryType EnumVal = EQueryType.eQueryTypeTracksByGenreId;


//---------------------------------------------------------------------------------------

		public eQueryTypeTracksByGenreId(ZuneQueryList ZQList, uint n) {
			object	o;

		}		// eQueryTypeTracksByGenreId ctor
	}		// eQueryTypeTracksByGenreId class
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypeAlbumsByGenreId {
		public static EQueryType EnumVal = EQueryType.eQueryTypeAlbumsByGenreId;


//---------------------------------------------------------------------------------------

		public eQueryTypeAlbumsByGenreId(ZuneQueryList ZQList, uint n) {
			object	o;

		}		// eQueryTypeAlbumsByGenreId ctor
	}		// eQueryTypeAlbumsByGenreId class
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypeUserCards {
		public static EQueryType EnumVal = EQueryType.eQueryTypeUserCards;


//---------------------------------------------------------------------------------------

		public eQueryTypeUserCards(ZuneQueryList ZQList, uint n) {
			object	o;

		}		// eQueryTypeUserCards ctor
	}		// eQueryTypeUserCards class
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypeTracksForTOC {
		public static EQueryType EnumVal = EQueryType.eQueryTypeTracksForTOC;


//---------------------------------------------------------------------------------------

		public eQueryTypeTracksForTOC(ZuneQueryList ZQList, uint n) {
			object	o;

		}		// eQueryTypeTracksForTOC ctor
	}		// eQueryTypeTracksForTOC class
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypePersonsByTypeId {
		public static EQueryType EnumVal = EQueryType.eQueryTypePersonsByTypeId;


//---------------------------------------------------------------------------------------

		public eQueryTypePersonsByTypeId(ZuneQueryList ZQList, uint n) {
			object	o;

		}		// eQueryTypePersonsByTypeId ctor
	}		// eQueryTypePersonsByTypeId class
...
//---------------------------------------------------------------------------------------
	...
	public class eQueryTypeVideoSeriesTitles {
		public static EQueryType EnumVal = EQueryType.eQueryTypeVideoSeriesTitles;


//---------------------------------------------------------------------------------------

		public eQueryTypeVideoSeriesTitles(ZuneQueryList ZQList, uint n) {
			object	o;

		}		// eQueryTypeVideoSeriesTitles ctor
	}		// eQueryTypeVideoSeriesTitles class
