...
// See http://www.pinvoke.net/default.aspx/Interfaces/IMetaDataAssemblyImport.html
// See also http://stackoverflow.com/questions/12843830/decompiled-winmd-file-contains-nothing-but-external-calls
//		and its comments about the relationship between a WinMD file and how to find the
//		implementation in the registry (HKLM\Software\Microsoft\WindowsRuntime\ActivatableClassID and the DllPath entries
// See http://stackoverflow.com/questions/9136683/cannot-get-types-from-winmd-file
// See https://msdn.microsoft.com/en-us/library/br229856%28v=vs.85%29.aspx?f=255&MSPPError=-2147217396
// See https://msdn.microsoft.com/en-us/library/ms404384.aspx

namespace PlayWithWinMd_2 {
	...
	public partial class PlayWithWinMd_2 : Form {
		public PlayWithWinMd_2() {
			InitializeComponent();

			// var xxx = Assembly.ReflectionOnlyLoad(@"C:\Windows\System32\WinMetaData\Windows.System.WinMD").GetReferencedAssemblies();
			var xxx = Assembly.ReflectionOnlyLoad(@"C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.Runtime.dll");
		}
	}
}
