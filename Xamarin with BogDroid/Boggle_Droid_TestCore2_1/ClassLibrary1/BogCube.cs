...
namespace Boondog2014_X {
	...
	public class BogCube : Button { // TODO: GelButtons.GelButton {	// TODO: TODO: TODO: Control {
		public static Boondog2014   BogForm;    // I *could* perhaps refer to a static
												// field in Boondog2014.cs, but hey, I
...
//---------------------------------------------------------------------------------------
		...
		public static void Init(Boondog2014 form) {
			BogForm = form;
		}
...
//---------------------------------------------------------------------------------------
		...
		protected override void OnPaint(PaintEventArgs e) {
			switch (BogForm.CubeFormat) {
				case Boondog2014.CubeFormats.Rainbow:
					OnPaintRainbow(e);
					break;
				default:
				case Boondog2014.CubeFormats.Glass:
					ShowAsGlass(e);
					break;
			}
		}
...
//---------------------------------------------------------------------------------------
		...
		private void OnPaintGlass(PaintEventArgs e, Font fnt) {
			...
			// Paint the text
			// var xxx = this.Parent as Boondog2014.Boondog2014;
...
public void LeftClickRoutine() {
			...
			if (!IsAdjacent(Boondog2014.board.CurrentWord)) {
			...
			SetHighlightColor();
			Boondog2014.board.CurrentWord.AppendCube(this);
			BogForm.ShowWordSoFar(Boondog2014.board.CurrentWord);
		}
		...
		protected override void OnDoubleClick(EventArgs e) {
			...
			// Boondog2014.board.LastWord = Boondog2014.board.CurrentWord;

			// Double-clicking on a square that isn't adjacent to the previous square
			// isn't allowed.
			// TODO: Isn't this checked for in LeftClickRoutine???
			if (!IsAdjacent(Boondog2014.board.CurrentWord, true)) {
				BogForm.SetStatusLine("Square clicked must be adjacent to the previous square", true);
				return;
			}

			Boondog2014.board.EndPlayerWord();
		}
#endif
#endif
