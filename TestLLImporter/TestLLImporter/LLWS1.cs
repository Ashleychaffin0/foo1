...
public partial class LLWS1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    private System.Threading.SendOrPostCallback ImportKeyedBasicDataOperationCompleted;
    ...
    /// <remarks/>
    public LLWS1() {
        this.Url = "http://198.64.249.219/LeadsLightningWS/LLWS1.asmx";
    }
    ...
    /// <remarks/>
    public event ImportKeyedBasicDataCompletedEventHandler ImportKeyedBasicDataCompleted;
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.LeadsLightning.com/ImportKeyedBasicData", RequestNamespace="http://www.LeadsLightning.com/", ResponseNamespace="http://www.LeadsLightning.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    public ImportStatus ImportKeyedBasicData(string UserID, string Password, string ImportingUserID, string ImportingPassword, int EventID, int Flags, string KeyedSwipeData, out ImportStatus[] RecordStatuses) {
        object[] results = this.Invoke("ImportKeyedBasicData", new object[] {
                    UserID,
                    Password,
                    ImportingUserID,
                    ImportingPassword,
    ...
    /// <remarks/>
    public System.IAsyncResult BeginImportKeyedBasicData(string UserID, string Password, string ImportingUserID, string ImportingPassword, int EventID, int Flags, string KeyedSwipeData, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("ImportKeyedBasicData", new object[] {
                    UserID,
                    Password,
                    ImportingUserID,
                    ImportingPassword,
                    EventID,
                    Flags,
                    KeyedSwipeData}, callback, asyncState);
    }
    
    /// <remarks/>
    public ImportStatus EndImportKeyedBasicData(System.IAsyncResult asyncResult, out ImportStatus[] RecordStatuses) {
        object[] results = this.EndInvoke(asyncResult);
        RecordStatuses = ((ImportStatus[])(results[1]));
        return ((ImportStatus)(results[0]));
    }
    ...
    /// <remarks/>
    public void ImportKeyedBasicDataAsync(string UserID, string Password, string ImportingUserID, string ImportingPassword, int EventID, int Flags, string KeyedSwipeData) {
        this.ImportKeyedBasicDataAsync(UserID, Password, ImportingUserID, ImportingPassword, EventID, Flags, KeyedSwipeData, null);
    }
    
    /// <remarks/>
    public void ImportKeyedBasicDataAsync(string UserID, string Password, string ImportingUserID, string ImportingPassword, int EventID, int Flags, string KeyedSwipeData, object userState) {
        if ((this.ImportKeyedBasicDataOperationCompleted == null)) {
            this.ImportKeyedBasicDataOperationCompleted = new System.Threading.SendOrPostCallback(this.OnImportKeyedBasicDataOperationCompleted);
        }
        this.InvokeAsync("ImportKeyedBasicData", new object[] {
                    UserID,
                    Password,
                    ImportingUserID,
                    ImportingPassword,
                    EventID,
                    Flags,
                    KeyedSwipeData}, this.ImportKeyedBasicDataOperationCompleted, userState);
    }
    
    private void OnImportKeyedBasicDataOperationCompleted(object arg) {
        if ((this.ImportKeyedBasicDataCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.ImportKeyedBasicDataCompleted(this, new ImportKeyedBasicDataCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
...
public enum ImportStatusErrCode {
    ...
    /// <remarks/>
    UserIDMismatchWithEventID,
    
    /// <remarks/>
    DuplicateKeyedFieldNames,
}
...
/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.312")]
public delegate void ImportKeyedBasicDataCompletedEventHandler(object sender, ImportKeyedBasicDataCompletedEventArgs e);

/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.312")]
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
public partial class ImportKeyedBasicDataCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    
    private object[] results;
    
    internal ImportKeyedBasicDataCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
