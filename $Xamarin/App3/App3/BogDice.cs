...
//---------------------------------------------------------------------------------------
		...
		/// board is > 5
		/// </summary>
		public static string[] SetupDice(int Rank) {
...
//---------------------------------------------------------------------------------------
		...
		/// </summary>
		public static bool ShakeDice(int Rank, BogCube[,] Cubes) {
			string[] Dice = BogDice.SetupDice(Rank);
			...
			foreach (string die in Dice) {
				...
				cube.Text = txt;
				cube.TextColor = Xamarin.Forms.Color.Black;	// TODO:
...
#if false
// Copyright (c) 2014-2018 by Larry Smith
