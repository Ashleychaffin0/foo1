...
namespace LRSS {
	/// <summary> 
	/// Summary description for WM_Messages. I found this on the web
	/// and cleaned it up a bit. Use it in overrride WndProc situations.
	/// </summary> 

// Note: The compiler complains with warning CS1591 if we've turned on XML comments,
// and these public enums don't have any. So turn off that warning.
