...
//---------------------------------------------------------------------------------------
		...
		public static void SaveQueriesAndSchemae(ZuneLibrary zl, string Filename) {
...
//---------------------------------------------------------------------------------------
		...
		private static List<SchemaMapAndType> GetSchemaeForEqueryType(ZuneQueryList ZQList, object xEQType) {
