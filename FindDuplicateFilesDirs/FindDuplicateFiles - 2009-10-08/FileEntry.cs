...
//---------------------------------------------------------------------------------------
		...
		public FileEntry(string PathName, long MinSize, long MaxSize, int PrefixSize) {
			...
			if ((FileSize < MinSize) || (FileSize > MaxSize) || (!IsDir)) { return; }
			//GetShortCRC(PrefixSize);
		}

//---------------------------------------------------------------------------------------

		void GetShortCRC(int nBytes) {
