...
namespace MovieCollection1.DVDCollectionDataSetTableAdapters {
...
SELECT ID, Title, Description, Actors, Director, Genre, Length, Rated, YearReleased, UPC, ImageLink, ImageBinary, WebPageLink, MyRating, Comments FROM DVDs WHERE (ID = @ID)";
		...
		private void InitConnection() {
			...
			this._connection.ConnectionString = global::MovieCollection1.Properties.Settings.Default.Connection1;
		}
