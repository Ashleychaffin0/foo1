...
namespace MovieCollection2 {
	...
	public partial class ListDetails : UserControl {
		...
		private void dt_RowChanged(object sender, System.Data.DataRowChangeEventArgs e) {
			...
			MovieCollection2.DVDCollectionDataSet.DVDsRow dvdDataRow = (MovieCollection2.DVDCollectionDataSet.DVDsRow)e.Row;
			if (dvdDataRow != null) {
				SaveData();
			}
		}
		...
		private void RefreshOnlineButton_Click(System.Object sender, System.EventArgs e) {
			...
			if (dialogResult == DialogResult.Yes) {
				...
				DVD refreshedDVD;
				MovieCollection2.DVDCollectionDataSet.DVDsRow refreshedDVDRow;
				...
				try {
					...
					if (this.dvdsDataConnector.Count > 0) {
						...
						MovieCollection2.DVDCollectionDataSet.DVDsRow dvdRow = (MovieCollection2.DVDCollectionDataSet.DVDsRow)rowView.Row;
		...
		private void ViewOnlineButton_Click(System.Object sender, System.EventArgs e) {
			...
			if (this.dvdsDataConnector.Count > 0) {
				//variables to store and preserve custom comment and rating values
				DataRowView rowView = (DataRowView)this.dvdsDataConnector.Current;
				DVDCollectionDataSet.DVDsRow dvdRow = (MovieCollection2.DVDCollectionDataSet.DVDsRow)rowView.Row;
